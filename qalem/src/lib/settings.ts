...
/**
 * Get the projects root directory (absolute path). This is where Qalem
 * lists and creates projects. Falls back to the default `~/Qalem` when no
 ...
 * default `~/Qalem`. Throws (with a user-facing message) if the chosen path
