/**
 * Plugin module loader for Qalem.
 *
...
export function exposeReactGlobals(React: any, ReactDOM: any): void {
  (window as unknown as Record<string, unknown>).__QALEM_REACT__ = React;
  (window as unknown as Record<string, unknown>).__QALEM_REACT_DOM__ = ReactDOM;
}
