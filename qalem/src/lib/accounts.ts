...
export interface Account {
   ...
   *  built-in default (`~/Qalem`). Each workspace can use its own folder. */
 ...
 */
export const ACCOUNTS_CHANGED_EVENT = 'qalem:accounts-changed';
 ...
 */
export const ACCOUNT_CREDENTIALS_CHANGED_EVENT = 'qalem:account-credentials-changed';
