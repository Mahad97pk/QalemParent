          ...
          <div className="settings-section">
              ...
              <div className="settings-row-info">
                ...
                <span className="settings-row-description">
                  {multipleWorkspaces && activeAccount
                    ...
                    : 'Where Qalem lists and creates your projects. Point this at an existing dev directory to keep everything in one place.'}
                </span>
                <button
                  type="button"
            ...
            <div className="settings-row">
              <div className="settings-row-info">
                ...
                <span className="settings-row-description">
                  ...
                  On macOS this may require Screen Recording permission — allow Qalem under
            ...
            <div className="settings-row">
              <div className="settings-row-info">
                ...
                <span className="settings-row-description">
                  Help improve Qalem by sharing usage data like feature usage, and errors.
                </span>
              </div>
              <button
