...
export function exposePluginContextRef(): void {
  (window as unknown as Record<string, unknown>).__QALEM_PLUGIN_CONTEXT_REF__ = PluginContext;
}
...
export function exposePluginContext(value: PluginContextValue | null): void {
  (window as unknown as Record<string, unknown>).__QALEM_PLUGIN_CONTEXT__ = value;
}
