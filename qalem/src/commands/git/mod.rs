...
/// Returns the configured projects root directory (custom or default `~/Qalem`).
#[tauri::command]
#[tracing::instrument]
pub async fn get_qalem_dir() -> Result<String, CommandError> {
...
#[tauri::command]
#[tracing::instrument]
pub async fn ensure_qalem_dir() -> Result<String, CommandError> {
...
pub async fn init_git_repo(project_path: String) -> Result<(), CommandError> {
    ...
    git_stage_and_commit(&validated_path, "Initial commit from Qalem")
