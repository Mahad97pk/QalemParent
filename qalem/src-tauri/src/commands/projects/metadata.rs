...
//!
//! Generic read/write of `.qalem/project.json`, plus the `has_vercel_config`
...
/// Reads project metadata from .qalem/project.json with automatic schema migration
#[tauri::command]
...
/// Writes project metadata to .qalem/project.json
