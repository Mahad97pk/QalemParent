...
//!
//! Fetches community templates from the Qalem API and downloads template zips.

use crate::errors::CommandError;

const TEMPLATES_API_URL: &str = "https://www.ship.studio/api/v1/templates";

/// Fetch community templates from the Qalem API.
...
pub async fn download_template_zip(url: String) -> Result<String, CommandError> {
    ...
    let tmp_dir = std::env::temp_dir().join("qalem-templates");
