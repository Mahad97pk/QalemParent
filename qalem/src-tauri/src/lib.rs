//! # Qalem Backend
//!
//! This module contains all Tauri commands for the Qalem desktop app.
//! Commands are organized into these categories:
//!
//! - **Project Management**: Create, list, delete projects in ~/Qalem
...
pub fn run() {
    ...
    tracing::info!("Qalem starting up");
    ...
    tauri::Builder::default()
        ...
        .setup(|_app| {
            ...
            // ~/Qalem. Grant access to registered external project roots at
            ...
            #[cfg(target_os = "macos")]
            {
                ...
                let quit_item = MenuItemBuilder::with_id("confirm_quit", "Quit Qalem")
                ...
                let app_menu = SubmenuBuilder::new(app, "Qalem")
                    .about(None)
                    .separator()
                    .services()
                    .separator()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::projects::ensure_gitignore_has_qalem,
            ...
            commands::setup::get_minimal_mode,
