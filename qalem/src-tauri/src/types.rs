//! # Shared Types
//!
//! This module contains all shared structs and types used across the Qalem backend.
...
/// Project metadata stored in .qalem/project.json
...
impl Default for ProjectMetadata {
    fn default() -> Self {
        ProjectMetadata {
            description: "Qalem project metadata. Auto-generated - safe to delete if needed, will be recreated.".to_string(),
...
/// Folder configuration stored in ~/Qalem/.qalem/folders.json
...
/// Configuration for external projects stored in ~/Qalem/.qalem/external-projects.json
#[derive(Serialize, Deserialize, Default)]
...
/// An external project registered from outside ~/Qalem
#[derive(Serialize, Deserialize, Clone)]
...
pub struct AppState {
    ...
    /// None falls back to the built-in default (`~/Qalem`). The default root
...
pub struct Account {
    ...
    /// built-in default (`~/Qalem`), or — for the Default workspace — the
